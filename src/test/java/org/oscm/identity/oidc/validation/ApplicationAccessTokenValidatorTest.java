...
public class ApplicationAccessTokenValidatorTest {

  @Mock private TenantService service;

  private KeyPair rsaKeys;
  private ApplicationAccessTokenValidator validator;
  ...
  public void shouldValidateAccessToken() {
    ...
    String token =
        JWT.create()
            .withClaim("aud", "expectedAudience")
    ...
    try {
      validator = new ApplicationAccessTokenValidator("default", tokenDetails, service);
      setStrategies();
      validator.validate();
  ...
  private void setTenantConfiguration() {
    ...
    tenantConfiguration.setAppIdUri("expectedAudience");
  }
  ...
  private void setStrategies() {
    ...
    validator.setApplicationAccessTokenAudienceValidationStrategy(
        new ApplicationAccessTokenAudienceValidationStrategy());
  }
