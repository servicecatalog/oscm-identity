...
public class MainController {
  ...
  public void idTokenCallback(
    ...
    TokenValidationResult validationResult = tokenValidator.validate(idToken);
   ...
   *
   * @param tokenString encoded token String
  ...
  public ResponseEntity verifyToken(
      ...
      @RequestParam(value = "tenantId", required = false) String tenantId) {
    TokenValidationResult validationResult = tokenValidator.validate(tokenString);
